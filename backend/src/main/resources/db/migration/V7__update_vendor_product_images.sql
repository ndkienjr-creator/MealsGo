-- Fix broken product images for vendor-created products (IDs 10, 11, 12)
-- These products currently point to /uploads/UUID.jpg files that return 401
-- Replace them with the new images added to /images/

-- Product ID 12: "phở" -> Chicken Pho image
...
-- Product ID 11: "bún" -> Bún Thịt Nướng image
UPDATE product_images
...
-- Product ID 10: "Bún" -> Cá Ba Sa Kho Tộ image
UPDATE product_images
